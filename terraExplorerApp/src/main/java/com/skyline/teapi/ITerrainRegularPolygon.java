...
public final class ITerrainRegularPolygon extends TEIUnknownHandle {
    private ITerrainRegularPolygon(int handle)
    {
        super(handle);
    }    
    public static ITerrainRegularPolygon fromHandle(int handle)
    {
        if(handle == 0)
            return null;
        return new ITerrainRegularPolygon(handle);
    }
    private final static java.util.UUID IID = java.util.UUID.fromString("18C939B5-D17E-4957-9E4B-5CA13834D074");
