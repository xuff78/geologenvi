...
public final class ITerrain3DRectBase extends TEIUnknownHandle {
    private ITerrain3DRectBase(int handle)
    {
        super(handle);
    }    
    public static ITerrain3DRectBase fromHandle(int handle)
    {
        if(handle == 0)
            return null;
        return new ITerrain3DRectBase(handle);
    }
    private final static java.util.UUID IID = java.util.UUID.fromString("C02FE4CB-93F6-4AE9-80FC-45751F13B4C1");
