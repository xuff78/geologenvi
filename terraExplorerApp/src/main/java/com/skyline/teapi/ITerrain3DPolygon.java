...
public final class ITerrain3DPolygon extends TEIUnknownHandle {
    private ITerrain3DPolygon(int handle)
    {
        super(handle);
    }    
    public static ITerrain3DPolygon fromHandle(int handle)
    {
        if(handle == 0)
            return null;
        return new ITerrain3DPolygon(handle);
    }
    private final static java.util.UUID IID = java.util.UUID.fromString("7D5A8FF5-05A8-4BB3-861C-8A955C3E370E");
