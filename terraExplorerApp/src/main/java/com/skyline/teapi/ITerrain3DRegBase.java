...
public final class ITerrain3DRegBase extends TEIUnknownHandle {
    private ITerrain3DRegBase(int handle)
    {
        super(handle);
    }    
    public static ITerrain3DRegBase fromHandle(int handle)
    {
        if(handle == 0)
            return null;
        return new ITerrain3DRegBase(handle);
    }
    private final static java.util.UUID IID = java.util.UUID.fromString("383E210A-FC90-4ABF-9B1C-873D162AB07B");
