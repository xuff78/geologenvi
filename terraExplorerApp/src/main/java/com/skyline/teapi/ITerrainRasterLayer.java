...
public final class ITerrainRasterLayer extends TEIUnknownHandle {
    private ITerrainRasterLayer(int handle)
    {
        super(handle);
    }    
    public static ITerrainRasterLayer fromHandle(int handle)
    {
        if(handle == 0)
            return null;
        return new ITerrainRasterLayer(handle);
    }
    private final static java.util.UUID IID = java.util.UUID.fromString("834D33D0-20A1-4792-A07D-8C27F59A48DB");
    ...
    {
        checkDisposed();
        boolean result = (NativeGetUseNull(this.getHandle()));
        TEErrorHelper.ThrowExceptionOnError();
        return result;
    }

    public void setUseNull(boolean value) throws ApiException
    {
        checkDisposed();
        NativeSetUseNull(this.getHandle(),value);
        TEErrorHelper.ThrowExceptionOnError();
    }
    ...
    {
        checkDisposed();
        Object result = (NativeGetNullValue(this.getHandle()));
        TEErrorHelper.ThrowExceptionOnError();
        return result;
    }

    public void setNullValue(Object value) throws ApiException
    {
        checkDisposed();
        NativeSetNullValue(this.getHandle(),value);
        TEErrorHelper.ThrowExceptionOnError();
    }
    ...
    {
        checkDisposed();
        double result = (NativeGetNullTolerance(this.getHandle()));
        TEErrorHelper.ThrowExceptionOnError();
        return result;
    }

    public void setNullTolerance(double value) throws ApiException
    {
        checkDisposed();
        NativeSetNullTolerance(this.getHandle(),value);
        TEErrorHelper.ThrowExceptionOnError();
    }
    ...
    {
        checkDisposed();
        double result = (NativeGetElevationScale(this.getHandle()));
        TEErrorHelper.ThrowExceptionOnError();
        return result;
    }

    public void setElevationScale(double value) throws ApiException
    {
        checkDisposed();
        NativeSetElevationScale(this.getHandle(),value);
        TEErrorHelper.ThrowExceptionOnError();
    }
    ...
    {
        checkDisposed();
        double result = (NativeGetElevationOffset(this.getHandle()));
        TEErrorHelper.ThrowExceptionOnError();
        return result;
    }

    public void setElevationOffset(double value) throws ApiException
    {
        checkDisposed();
        NativeSetElevationOffset(this.getHandle(),value);
        TEErrorHelper.ThrowExceptionOnError();
    }
    ...
    {
        checkDisposed();
        String result = (NativeGetDataSourceWKT(this.getHandle()));
        TEErrorHelper.ThrowExceptionOnError();
        return result;
    }

    public IBBox2D getDataSourceBBox() throws ApiException
    {
        checkDisposed();
        IBBox2D result = IBBox2D.fromHandle(NativeGetDataSourceBBox(this.getHandle()));
        TEErrorHelper.ThrowExceptionOnError();
        return result;
    }
    ...
    public void Refresh(int AutoRefreshTimeInterval) throws ApiException
    {
        checkDisposed();
        NativeRefresh(this.getHandle(),AutoRefreshTimeInterval);
        TEErrorHelper.ThrowExceptionOnError();
    }
...
private static native boolean NativeGetUseNull(int instance);

private static native void NativeSetUseNull(int instance,boolean pVal);

private static native Object NativeGetNullValue(int instance);

private static native void NativeSetNullValue(int instance,Object pVal);

private static native double NativeGetNullTolerance(int instance);

private static native void NativeSetNullTolerance(int instance,double pVal);

private static native double NativeGetElevationScale(int instance);

private static native void NativeSetElevationScale(int instance,double pVal);

private static native double NativeGetElevationOffset(int instance);

private static native void NativeSetElevationOffset(int instance,double pVal);

private static native String NativeGetDataSourceWKT(int instance);

private static native int NativeGetDataSourceBBox(int instance);

private static native Object NativeGetParam(int instance,int Code);

private static native void NativeRefresh(int instance,int AutoRefreshTimeInterval);
