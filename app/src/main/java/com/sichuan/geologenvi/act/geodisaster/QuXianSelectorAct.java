 ...
 */
public class QuXianSelectorAct extends AppFrameAct {
    TextView txtcount;
    int type=0;
    TextView selectArea;
...
//        });
        ...
        findViewById(R.id.confirmBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(selectedAreaInfo!=null) {
                    ...
                    intent.putExtra("Area", selectedAreaInfo.getName());
    ...
    private void requestArea(){
        ...
        if(temps.size()>0) {
            ...
            recyclerView.setAdapter(new MenuListAdapter(QuXianSelectorAct.this, list, listener));
        }else {
            selectedDistrict.removeLast();
            ToastUtils.displayTextShort(QuXianSelectorAct.this, "已经是最后一级");
        }
    }
