package com.sichuan.geologenvi.act;
        ...
        import com.sichuan.geologenvi.adapter.RainQXAdapter;
...
/**
 * Created by cuikl on 2017/7/29.
 */
public class RainQXAct extends AppFrameAct {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rainqx_layout);
    ...
    private void initHandler() {
        handler=new HttpHandler(this, new CallBack(this){
            ...
            public void onHTTPException(String method, String jsonMessage) {
                String jsonData= SharedPreferencesUtil.getString(RainQXAct.this, ConstantUtil.rain_info);
                showResult(jsonData);
            }

            @Override
            public void doSuccess(String method, String jsonData) {
                SharedPreferencesUtil.setString(RainQXAct.this, ConstantUtil.rain_info, jsonData);
                showResult(jsonData);
            }
            ...
            private void showResult(String jsonData){
                if(jsonData.equals(SharedPreferencesUtil.FAILURE_STRING)){
                    DialogUtil.showInfoDailog(RainQXAct.this, "提示", GlbsNet.HTTP_ERROR_MESSAGE);
                }else {
                    rainInfo = JsonUtil.getRainInfo(jsonData);
                    adapter = new RainQXAdapter(RainQXAct.this, rainInfo);
...
//                            }
                            String qx=rains[i].getQx();



                            RainsBean rainsBean=new RainsBean();
                            rainsBean.setItems(rains);
                            Intent intent=new Intent(RainQXAct.this, RainAct.class);
                            intent.putExtra("Title", "雨量监测");
                            intent.putExtra("QX",qx);
                            startActivity(intent);

//                            Intent chat=new Intent(RainQXAct.this, ChatRain.class);
