 ...
 */
public class EditItemAdapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    ...
    public EditItemAdapter1(Activity act, ArrayList<Map<String, String>> datalist, String[] titleKey, View.OnClickListener itemListener)
    {
